                            ...
                            <div class="row">
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="celular" id="celular" value="{{old('celular')}}" class="form-control" placeholder="Teléfono">
                                ...
                                <div class="col-xs-3 col-sm-3 col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nocalle" id="nocalle" value="{{old('nocalle')}}" class="form-control" placeholder="Número de Calle">
